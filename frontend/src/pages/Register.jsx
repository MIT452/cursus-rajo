    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-950 px-6 py-24">
      ...
      >
        ...
        <div className="rounded-xl2 border border-white/8 bg-ink-800/60 p-8 backdrop-blur-sm">
          <h1 className="font-display text-2xl text-paper-50">Creez votre compte</h1>
          <p className="mt-1 text-sm text-paper-400">Explorez le catalogue et suivez votre progression.</p>
        ...
        <p className="mt-6 text-center text-sm text-paper-400">
          Deja inscrit ?{" "}
          <Link to="/connexion" className="text-violet-400 hover:text-violet-300">
            Connectez-vous
          </Link>
        </p>
      </motion.div>
